...
- **Colorblindness Filters**: Thanks to Github User @Altreus we managed to get some filters por people with eight different types of color blindness. To access this filters you just need to click on the eye icon at the footer of each page.
